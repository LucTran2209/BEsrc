...
namespace BE.Persistence.DependencyInjections
{
    public static class DependencyInjection
    {
        public static IServiceCollection AddPersistenceServices(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddTransient<IDataSeedContributor, RolesDataSeedContributor>();
            //services.AddTransient<IDataSeedContributor, RolesDataSeedContributor>();
            //services.AddTransient<IDataSeedContributor, UsersDataSeedContributor>();
            //services.AddTransient<IDataSeedContributor, PositionsDataSeedContributor>();
            //services.AddTransient<IDataSeedContributor, AdjustmentsDataSeedContributor>();
            //services.AddTransient<IDataSeedContributor, EmployeesDataSeedContributor>();
            //services.AddTransient<IDataSeedContributor, WorkingHoursDataSeedContributor>();
